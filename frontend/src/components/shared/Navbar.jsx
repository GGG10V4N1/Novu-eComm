...
import { syncCartWithProducts } from "../../store/actions";
...
const Navbar = () => {
    ...
    // Reconcilia el carrito con la BD al montar la app (silencioso)
    // para detectar productos borrados/descontinuados mientras el
    // usuario navega. Se ejecuta solo una vez en el montaje.
    useEffect(() => {
        dispatch(syncCartWithProducts(null));
        ...
        <div className="h-[70px] bg-custom-gradient text-white z-50 flex items-center sticky top-0">
            <div className="lg:px-14 sm:px-8 px-4 w-full flex justify-between">
                <Link to="/" className="flex items-center text-2xl font-bold">
                    ...
                    <span className="font-[Poppins]">Novu</span>
                </Link>
