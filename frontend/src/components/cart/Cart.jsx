...
const Cart = () => {
    ...
    useEffect(() => {
        if (cart && cart.length > 0) {
            dispatch(syncCartWithProducts(toast));
        }
        // Se sincroniza contra la BD solo al montar el Cart; no queremos
        // re-disparar la validacion en cada cambio del carrito local.
    ...
    return (
        <div className="lg:px-14 sm:px-8 px-4 py-10">
            ...
            <div className="grid md:grid-cols-6 grid-cols-4 gap-4 pb-2 font-semibold items-center">
                ...
                <div className="hidden md:block text-lg text-slate-800">
                    Description
                </div>
